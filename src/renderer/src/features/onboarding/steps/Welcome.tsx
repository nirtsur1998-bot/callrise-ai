    ...
    <div className="text-center">
      ...
      <div className="mt-6 space-y-2.5">
        ...
        <button
          ...
          onClick={onSkip}
          disabled={busy}
          className="flex w-full items-center justify-center gap-2 rounded-lg px-3.5 py-2.5 text-sm font-medium text-muted transition hover:text-ink disabled:opacity-50"
        >
