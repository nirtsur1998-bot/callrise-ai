...
export function OtherPartyControl({ consent, onOpen }: OtherPartyControlProps): React.JSX.Element {
  ...
  if (!supportsOtherPartyCapture) {
    return (
      <Tooltip content="Recording the other party isn't available on this platform — your own mic still transcribes normally.">
        <span className="no-drag flex cursor-not-allowed items-center gap-1.5 rounded-lg border border-line px-2.5 py-1.5 text-xs font-medium text-faint">
