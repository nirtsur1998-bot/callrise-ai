          ...
          properties: {
            ...
            category: {
              ...
              description:
                ...
                `A fact about the CLIENT (scopeKind 'client') uses one of the client categories: ${CLIENT_CATEGORY_RULE} ` +
                `The other categories describe the rep or the rep's own business. ` +
